...
public class Myinfo extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		out.println("아이디 : <input type = 'text' name = 'userId' value ='"
				+ memberOne.getUserId() + "' /> <br>");
		
		out.println("패스워드 : <input type = 'text' name = 'userPwd' value = '" 
				+ memberOne.getUserPwd() + "' /> <br>");
		
		out.println("이름 : <input type = 'text' name = 'userName' value ='"
				+ memberOne.getName() + "' /> <br>");
